      ...
      <div className="w-[100wv] h-[100vh] bg-[#1a1818]">
        <div className="flex">
          ...
          <div className="left-nav">
            <div className="left-nav-item-work">
              <a href="/home">Home</a>
            </div>

            {/* the line */}
            <div className="left-nav-line-work"></div>

            {/* copywrite */}
            <div className="left-nav-copyright-withoutLinks">
              <div className="left-nav-copyright-item-work">@/2024</div>
            </div>
          </div>
          ...
          <div className="section-left">
            <div className="section-left-content">
              ...
              <div className="header-description-work">
                <p>
                  Welcome to a collection of my finest projects, where I combine
                  creativity and strategy to deliver impactful solutions in web
                  development, no-code innovation, product design, and
                  management. Each piece reflects my passion for turning ideas
                  into reality
                </p>
              </div>
            </div>
            ...
            <div className="section-right-content ">
              <ul>
                {WorkList.map((links, index) => (
                  <li key={index} className="section-right-link-work">
